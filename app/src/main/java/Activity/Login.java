...
public class Login extends AppCompatActivity {
    ...
    public void init() {
        ...
        buttonlog =  findViewById(R.id.btlogin);
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()) {
                    ...
                    if (user.isEmailVerified()) {
                        ...
                        Intent i = new Intent(Login.this, Splash_welcome_user.class);
                        startActivity(i);
                    } else {
                        progressDialog.cancel();
                        Toast.makeText(Login.this, "Kiểm tra email để xác nhận! Nếu bạn không thấy hãy kiểm tra thư mục spam", Toast.LENGTH_LONG).show();
                    }
